...
use App\Livewire\Pages\LaporanGuru;
use App\Livewire\Pages\PendaftaranSiswaBaru;
use App\Livewire\Pages\Presensi;
use App\Livewire\Pages\ProfilGuru;
...
Route::get('/pendaftaran-siswa-baru', PendaftaranSiswaBaru::class)->name('public.siswa-baru');
...
Route::middleware(['auth', 'force.password.change', 'akses:guru'])->group(function () {
    ...
    Route::get('/sensei/profil', ProfilGuru::class)->name('sensei.profil');
    Route::get('/sensei/laporan', LaporanGuru::class)->name('sensei.laporan');
    Route::get('/sensei/laporan/formulir-nilai', [ReportController::class, 'monthlyScoreSheet'])->name('sensei.reports.monthly-score');
    Route::get('/sensei/laporan/absensi', [ReportController::class, 'monthlyAttendanceSheet'])->name('sensei.reports.attendance');
    Route::get('/sensei/dokumen/{type}/{nis}', [StudentDocumentController::class, 'download'])->name('sensei.documents.download');
