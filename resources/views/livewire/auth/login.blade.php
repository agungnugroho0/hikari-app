    ...
    <div class="flex-1 flex justify-center items-center">
        <div class="relative">
            ...
            <section class="relative grid gap-2 grid-cols-1 md:grid-cols-2 w-full md:max-w-4xl
                ...
                <span class="text-xs text-gray-500 p-8 ">Tidak bisa login, hubungi tim | 
                    <a href="https://agungnugroho0.github.io/portofolio/" class="cursor-pointer text-xs text-gray-300 underline">Developer</a>
                </span>
                <p class="text-sm text-gray-400 absolute bottom-5 right-6 md:hidden pointer-events-none">© Copyright 2026. Hak cipta dilindungi Undang-undang 
                </p>
