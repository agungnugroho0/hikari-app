...
new class extends Component {
    ...
    public $id;
    #[On('loadEditJob')]
    public function loadEditJob($id)
    {
        // dd($id);
    ...
    {
        return $this->so = So::all();
    }
};
?>

<div>
    <form wire:submit.prevent="updates" class="grid grid-cols-2 gap-3">
        <input type="text" wire:model="jobfair.id_job" name="id_job" hidden>
